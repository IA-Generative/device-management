...
Verify presign URL:
```
curl -sS -o /dev/null -D - https://<SCALEWAY_HOSTNAME>/binaries/matisse/evolution.png
```

Proxy should return 200 without redirect:
```
curl -sS -o /dev/null -D -L https://<SCALEWAY_HOSTNAME>/binaries/matisse/evolution.png
```
