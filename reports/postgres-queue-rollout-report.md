...
_Date_: 2026-03-07
_Repository_: `/Users/<USER>/Documents/GitHub/device-management`
...
```bash
# 1) Snapshot securite
cd /Users/<USER>/Documents/GitHub/device-management
...
Deploiement live:
- image push: `<SCALEWAY_REGISTRY>/device-management:0.0.4-unified-relay`
- rollout API: OK (3/3)
