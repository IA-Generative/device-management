...
| [adr-0002-proxy-llm-relais.md](adr-0002-proxy-llm-relais.md) | Proxy LLM `/llm/v1` (0.9.0) — découplage IAssistant+DM vs backend banalisé, asymétrie des cycles de vie, sécabilité du relais, quotas Postgres, auth duale | En vigueur |
