...
class PluginSummary(BaseModel):
    ...
    icon_url: str | None = Field(None, example="https://<SCALEWAY_HOSTNAME>/catalog/icons/mirai-libreoffice.png")
    detail_url: str = Field(..., example="https://<SCALEWAY_HOSTNAME>/catalog/mirai-libreoffice")
    download_url: str = Field(..., example="https://<SCALEWAY_HOSTNAME>/catalog/mirai-libreoffice/download")
  ...
  "plugins": [
    {
      ...
      "detail_url": "https://<SCALEWAY_HOSTNAME>/catalog/mirai-libreoffice",
      "download_url": "https://<SCALEWAY_HOSTNAME>/catalog/mirai-libreoffice/download"
    }
  ],
  "total": 2,
...
<script>
fetch('https://<SCALEWAY_HOSTNAME>/catalog/api/plugins')
  .then(r => r.json())
  .then(data => {
