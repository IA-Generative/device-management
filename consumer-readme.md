...
```
curl -sS https://<SCALEWAY_HOSTNAME>/config/config.json | python -c 'import json,sys; print(json.load(sys.stdin).get("updateUrl"))'
```
...
curl -sS -o /dev/null -D - \
  https://<SCALEWAY_HOSTNAME>/binaries/ok/ok.png
```
